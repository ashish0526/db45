...
// ExprOp identifies an operator: arithmetic, boolean, unary, and the four range
// comparisons (numbered as in the lesson; 12–15 are the range ops used by
// RangeReq).
type ExprOp uint8
